...
export const SidebarNav: React.FC<SidebarNavProps> = ({
  ...
  return (
    <aside
      className={`bg-[#0B0F17]/95 border-r border-slate-800/90 transition-all duration-300 flex flex-col justify-between select-none z-30 sticky top-0 h-screen font-sans backdrop-blur-xl ${
      ...
      <div className="p-4 border-b border-slate-800/80 flex items-center justify-between">
        ...
        {!isCollapsed ? (
          <button
            ...
            className="p-2 rounded-xl bg-[#111827] hover:bg-slate-800 text-slate-400 hover:text-white border border-slate-800 hidden md:flex items-center justify-center transition-all shadow-sm active:scale-95"
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-[#111827] hover:bg-slate-800 text-slate-400 hover:text-white border border-slate-800 hidden md:flex items-center justify-center transition-all shadow-sm active:scale-95"
        ...
        {NAV_HUBS.map((hub, idx) => {
          ...
          return (
            <div key={hub.id} className="space-y-1.5">
              ...
              {/* Sub-tools Drawer (Larger, High-Legibility Typography!) */}
